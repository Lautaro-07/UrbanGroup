...
// Database settings: choose 'sqlite' or 'mysql'
if (!defined('DB_TYPE')) {
    define('DB_TYPE', 'mysql'); // change to 'mysql' in production and set DB_* below
}

// MySQL settings (used only when DB_TYPE === 'mysql')
if (!defined('DB_HOST')) {
