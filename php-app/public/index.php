...
<section class="relative h-[500px] md:h-[600px] lg:h-[700px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 lg:px-8 text-center">
        ...
        <!-- Search Form -->
        <form action="<?= BASE_URL ?>propiedades.php" method="GET" class="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-4 md:p-6 lg:p-8 max-w-6xl mx-auto">
...
document.getElementById('regionSelect').addEventListener('change', function() {
    ...
    fetch('<?= BASE_URL ?>api/get-comunas.php?region_id=' + regionId)
        .then(r => r.json())
        .then(comunas => {
            comunaSelect.innerHTML = '<option value="">Seleccionar</option>';
            comunas.forEach(c => {
