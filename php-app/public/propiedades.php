...
$selectedPropertyTypeId = $_GET['property_type'] ?? '';
...
if (!empty($_GET['property_type'])) {
    ...
    if ($typeName) {
        ...
        $selectedPropertyTypeName = $typeName;
    }
}
...
$filterConfig = [
    ...
    'Local Comercial' => ['built_area' => true, 'bathrooms' => true],
    'Bodega' => ['built_area' => true, 'total_area' => true],
    'Parcela' => ['total_area' => true],
    'Terreno' => ['total_area' => true],
    'default' => ['bedrooms' => true, 'bathrooms' => true, 'built_area' => true, 'parking' => true]
];

$activeFilters = $filterConfig[$selectedPropertyTypeName] ?? $filterConfig['default'];
    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-8">
        <form action="" method="GET" id="filterForm">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
                ...
                <select name="property_type" id="propertyTypeFilter" class="px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" onchange="this.form.submit()">
                    <option value="">Tipo de Propiedad</option>
                    <?php foreach ($types as $t): ?>
                        <?php if (empty($t['is_usa'])): ?>
                        <option value="<?= $t['id'] ?>" <?= $selectedPropertyTypeId == $t['id'] ? 'selected' : '' ?>>
