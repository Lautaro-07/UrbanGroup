    ...
    <div class="max-w-md mx-auto px-4">
        <div class="bg-white rounded-xl shadow-lg p-8">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-900">Acceso Clientes</h1>
            ...
            <div id="formRegister" class="hidden">
                <form method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="tel" name="celular" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
