...
<body>
    ...
    <div class="signature-section">
        ...
        <table style="width: 100%; margin-top: 30px;">
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <div class="signature-box">
                        <p style="margin: 0;">Urban Group SpA</p>
    ...
    <div class="footer">
        <p>Documento generado automaticamente el ' . date('d/m/Y H:i') . ' - Urban Group SpA - www.urbangroup.cl</p>
    </div>
</body>
</html>';
...
if ($action === 'send_orden_visita' || (!empty($input['property_ids']) && $_SERVER['REQUEST_METHOD'] === 'POST')) {
    try {
        ...
        $headers .= "Reply-To: " . ($client['email'] ?? 'noreply@urbangroup.cl') . "\r\n";
