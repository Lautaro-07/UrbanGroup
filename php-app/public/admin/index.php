...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($postAction === 'toggle_partner_active' && !empty($_POST['user_id'])) {
        ...
        if ($partner) {
            ...
            // Update all partner's properties to match the new status
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="h-40 bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center overflow-hidden">
                            <?php if (!empty($partner['photo_url'])): ?>
                                <img src="<?= htmlspecialchars($partner['photo_url']) ?>" alt="<?= htmlspecialchars($partner['name']) ?>" class="w-full h-full object-cover" loading="lazy">
                            <?php else: ?>
                ...
                <form method="POST" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="w-full h-40 bg-gradient-to-br from-blue-200 to-blue-300 rounded-lg flex items-center justify-center overflow-hidden mb-3">
                            <?php if (!empty($editPartner['photo_url'])): ?>
                                <img src="<?= htmlspecialchars($editPartner['photo_url']) ?>" alt="<?= htmlspecialchars($editPartner['name']) ?>" class="w-full h-full object-cover" loading="lazy">
                            <?php else: ?>
