...
class TerrenoModel {
    ...
    private $numericFields = [
        'altura_maxima', 'rasante', 'coef_constructibilidad_max', 'coef_ocupacion_suelo_max',
        'coef_area_libre_min', 'antejardin_min', 'frente', 'fondo', 'superficie_total_terreno',
    ...
    public function getTerrenos($filters = [], $limit = null, $offset = 0) {
        ...
        if (!empty($filters['estado'])) {
            ...
            } elseif ($filters['estado'] === 'activo_null') {
                $sql .= " AND (td.estado = 'Activo' OR td.estado IS NULL OR td.estado = '')";
            } else {
                $sql .= " AND td.estado = ?";
